...
export class CoreML {
  ...
  readonly modelInfo: {
    ...
    prepare(params: CoreMLModelInfoParams): PreparedCall<"coreml.model_info">;
  };
  readonly embed: {
    (
  ...
  readonly embedBatch: {
    ...
    prepare(params: CoreMLEmbedBatchParams): PreparedCall<"coreml.embed_batch">;
  };
  ...
  constructor(client: DarwinKitClient) {
    ...
    this.modelInfo = method(client, "coreml.model_info") as CoreML["modelInfo"];
